 ...
 */
final class Version20240313213223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coolant_temp (id INT AUTO_INCREMENT NOT NULL, vehicle_id INT DEFAULT NULL, value VARCHAR(255) NOT NULL, date DATETIME NOT NULL, INDEX IDX_BAA1EDA2545317D1 (vehicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
